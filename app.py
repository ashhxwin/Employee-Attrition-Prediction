...
def main():
    st.header('Employee Attrition Prediction App')
    st.markdown(""" Powered by Streamlit - The powerful app to deploy Python Apps and Engines """)
    
    def input_features() :
        st.sidebar.header('Drag the sliders to change the variables.')
    ...
    ans = round(100*ans,2)
    st.subheader(f'The probability of the employee being released is {ans} percent.')
